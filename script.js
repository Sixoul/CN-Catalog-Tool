...
// --- MODALS & CRUD ---
// NEWS
function openNewsModal(id=null) { editingId = id; if(id) { const item = newsData.find(n => n.id === id); document.getElementById('news-input-title').value = item.title; document.getElementById('news-input-date').value = item.date; document.getElementById('news-input-badge').value = item.badge; } else { document.getElementById('news-input-title').value = ''; document.getElementById('news-input-date').value = ''; document.getElementById('news-input-badge').value = ''; } document.getElementById('news-modal').style.display = 'flex'; }
...
// RULES
function openRulesModal(id=null) { editingId = id; if(id) { const item = rulesData.find(r => r.id === id); document.getElementById('rule-input-title').value = item.title; document.getElementById('rule-input-desc').value = item.desc; document.getElementById('rule-input-penalty').value = item.penalty; } else { document.getElementById('rule-input-title').value = ''; document.getElementById('rule-input-desc').value = ''; document.getElementById('rule-input-penalty').value = ''; } document.getElementById('rules-modal').style.display = 'flex'; }
